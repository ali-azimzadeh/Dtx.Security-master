...
namespace Data
{
	...
	public class ApplicationRepository : Repository<Models.Application>, IApplicationRepository
	{
        ...
        /// </returns>
        public List<Models.Application> GetApplicationsByIsIPRestricted(bool isIPRestricted)
        {
            var result =
                DbSet
        ...
        /// Return List of application records that isIPRestricted field is true or false
        /// </returns>
        public virtual async Task<List<Application>> GetApplicationsByIsIPRestrictedAsync(bool isIPRestricted)
        {
            var result =
                await
                DbSet
        ...
        public List<Models.Application> GetApplicationsByIsURLRestricted(bool isURLRestricted)
        {
            var result =
                DbSet
        ...
        /// Return List of application records that isURLRestricted field is true or false
        /// </returns>
        public virtual async Task<List<Application>> GetApplicationsByIsURLRestrictedAsync(bool isURLRestricted)
        {
            var result =
                       await
                       DbSet
